...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  { value: "new_message_received", label: "Nova mensagem", hint: "Qualquer mensagem recebida" },
  {
    value: "first_inbound_message",
    label: "Primeira mensagem do contato",
    hint: "Primeira vez que este contato te envia uma mensagem (também funciona para contatos adicionados manualmente)",
  },
  { value: "keyword_match", label: "Palavra-chave", hint: "Mensagem contém palavra(s)-chave específica(s)" },
  { value: "new_contact_created", label: "Novo contato", hint: "Quando um contato é criado automaticamente a partir de uma mensagem recebida" },
  ...
  { value: "time_based", label: "Por horário", hint: "Em uma agenda recorrente" },
]
