      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Desconecte-se de todos os dispositivos onde você está conectado —
            incluindo este. Útil se você perdeu um notebook ou compartilhou sua
            senha.
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              e precisarão entrar novamente. Você será redirecionado para a
              página de login.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
