...
export function WhatsAppConfig() {
  ...
  async function handleReset() {
    if (!confirm('Isto vai excluir a configuração atual do WhatsApp para que você possa reinseri-la. Continuar?')) {
      return;
    }
    ...
    return (
      <section className="animate-in fade-in-50 duration-200">
        <SettingsPanelHead
          ...
          description="Conecte sua API do WhatsApp Business da Meta. Credenciais, webhook e passos de configuração ficam todos aqui."
        />
      ...
      <div className="space-y-6">
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  registro, ou o registro foi ignorado. Insira o PIN de duas
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {config && !tokenEdited && (
                <p className="text-xs text-muted-foreground">
                  O token fica oculto por segurança. Reinsira-o para atualizar a configuração.
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Uma string personalizada criada por você. Deve coincidir com o token definido nas configurações de webhook da Meta.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                <strong className="text-muted-foreground">entrada</strong>{' '}
                de um número de{' '}
                ...
                último app que reivindicou o número (o sintoma que afeta números
                secundários sob uma WABA compartilhada).{' '}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como o callback de webhook no Painel de Apps da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
