...
describe("mondayIndex", () => {
  // Datas em horário LOCAL (new Date(ano, mêsIndex, dia)) — não "2026-05-18"
  // (parseada em UTC), que em fusos atrás de UTC cai no dia anterior e quebra
  // o getDay(). Maio = índice 4.
  ...
  it("aligns with DOW_SHORT_MON_FIRST labels", () => {
    // Labels são PT-BR (a UI foi traduzida): Seg..Dom.
